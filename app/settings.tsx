  ...
  return (
    <PaperBackground>
      <SafeAreaView className="flex-1" edges={['top', 'bottom']}>
        <ScreenHeader title="Settings" onBack={handleBack} backLabel="Back to home" />

        <ScrollView
          contentContainerStyle={{ paddingHorizontal: 20, paddingBottom: 34, paddingTop: 6 }}
          showsVerticalScrollIndicator={false}
        >
          <View
            className="overflow-hidden rounded-card border"
            style={[
              { backgroundColor: UI_COLORS.paper, borderColor: UI_COLORS.paperLine },
              SHADOW.card,
            ]}
          >
            <SettingRow
            ...
            />
            <View className="h-px" style={{ backgroundColor: UI_COLORS.paperLine }} />
            <SettingRow
              icon="music"
          ...
          <Text className="mt-8 mb-3 px-1 text-sm font-bold uppercase" style={{ color: UI_COLORS.inkMuted, letterSpacing: 1 }}>
            Progress
          </Text>
          ...
          >
            <Text className="text-base" style={{ color: UI_COLORS.inkSoft }}>
              You have completed{' '}
              <Text className="font-bold" style={{ color: UI_COLORS.ink }}>
            ...
            <View className="mt-4">
              <Button
                ...
                icon={<Icon name="trash" size={18} color="#FFFFFF" />}
                accessibilityHint="Asks for confirmation before deleting all progress"
              />
            </View>
          </View>

          <Text className="mt-8 text-center text-xs" style={{ color: UI_COLORS.inkMuted }}>
            Liquid Color Sort plays entirely offline.{'\n'}No ads, no accounts, no tracking.
          </Text>
        </ScrollView>
      </SafeAreaView>
    </PaperBackground>
