...
function IconComponent({ name, size = 22, color, strokeWidth = 2 }: IconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      {name === 'play' ? <Path d="M7 4.5 19 12 7 19.5Z" {...common} fill={color} /> : null}
      ...
      {name === 'back' ? <Polyline points="15,4 7,12 15,20" {...common} /> : null}
      ...
      {name === 'check' ? <Polyline points="4.5,12.5 9.5,17.5 19.5,6.5" {...common} /> : null}

      {name === 'sound' ? (
        <>
          <Path d="M4 9.5h3.5L12 5.5v13L7.5 14.5H4Z" {...common} />
          <Path d="M15.8 9a4.2 4.2 0 0 1 0 6M18.4 6.4a7.8 7.8 0 0 1 0 11.2" {...common} />
        </>
      ) : null}
      ...
      {name === 'trash' ? (
        <>
          ...
          <Path d="M6.5 6.5 7.4 19a1.8 1.8 0 0 0 1.8 1.6h5.6a1.8 1.8 0 0 0 1.8-1.6l.9-12.5" {...common} />
        </>
      ) : null}
    </Svg>
  );
